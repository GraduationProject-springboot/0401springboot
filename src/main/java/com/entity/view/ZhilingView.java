...
*/
@TableName("zhiling")
public class ZhilingView extends ZhilingEntity implements Serializable {
	...
	public ZhilingView(ZhilingEntity zhilingEntity) {
		try {
			BeanUtils.copyProperties(this, zhilingEntity);
